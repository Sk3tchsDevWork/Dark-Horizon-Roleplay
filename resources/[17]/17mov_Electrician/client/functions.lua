...
function StartMinigame(icons, time, difficulty)
    -- Map string difficulties to numeric levels (1 = easy, 2 = medium, 3 = hard)
    local diffMap = {
        easy   = 1,
        medium = 2,
        hard   = 3,
    }
    local diffLevel = diffMap[string.lower(difficulty)] or 1

    -- Launch the ElectricalBox minigame
    return exports['tgg-minigames']:ElectricalBox({
