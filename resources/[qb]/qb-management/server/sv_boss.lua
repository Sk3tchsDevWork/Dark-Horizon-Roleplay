...
-- Export AddMoney so other resources can access it
exports("AddMoney", function(society, amount)
    TriggerEvent("qb-bossmenu:server:addAccountMoney", society, amount)
end)

exports("AddGangMoney", function(society, amount)
    TriggerEvent("qb-bossmenu:server:addAccountMoney", society, amount) -- Replace with gang-specific if needed
end)

exports("RemoveMoney", function(society, amount)
    TriggerEvent("qb-bossmenu:server:removeAccountMoney", society, amount)
end)

exports("RemoveGangMoney", function(society, amount)
    TriggerEvent("qb-bossmenu:server:removeAccountMoney", society, amount) -- Replace with gang-specific if needed
end)
