                ...
                if confirmRaid == "confirm" then
                    ...
                    if Config.ConsumeRaidItem then
                        ...
                        if Config.Inventory == 'ox' then
                            ...
                            if lib.checkDependency('ps-inventory', '2.0.0') then
                                TriggerClientEvent("ps-inventory:client:ItemBox", src, QBCore.Shared.Items[raidItem], "remove")
                                exports['ps-inventory']:RemoveItem(source, raidItem, 1)
                            else
...
RegisterNetEvent("ps-housing:server:openQBInv", function(data)
    ...
    exports['ps-inventory']:OpenInventory(src, stashId, stashData)
end)
