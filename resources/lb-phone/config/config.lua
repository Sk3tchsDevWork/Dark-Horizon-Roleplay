...
Config.CustomApps = {
    ["banking"] = {
        ...
        game = false,
        size = 59812,
        images = { "https://example.com/banking-app.jpg" },
        icon = "https://cfx-nui-" .. GetCurrentResourceName() .. "/ui/bank.png",
        price = 0,
        landscape = false,
        keepOpen = true,
        onUse = function()
            local QBCore = exports['qb-core']:GetCoreObject()
            print("Banking app opened, citizenid:", QBCore.Functions.GetPlayerData().citizenid)
