Config = {
	...
	BarLicensePrice = 1, -- Set this to the cost you would like to charge for the bar license exam.
	...
	Phone = {GKSPhone = false, QBPhone = true, QuasarPhone = false, HighPhone = false, RoadPhone = false, LBPhone = true, Yseries = false, Custom = false}, -- Set to the phone you use to true, if you do not have one of these phones then set Custom to true and edit the function in webhooks.lua.
	Interactions = {qbTarget = true, qTarget = false, ox_target = false, drawText = false},
	Context = {QB = true, OX = false, AP = true}, -- Set this to to "QB", More added soon.
	Dialog = {QB = true, OX = false, AP = true}, -- Set this to to "QB", More added soon.
...
Config.ExamScript = {AP = true, BCS = false}
...
Config.ExamOptions = {
	...
	image = 'https://www.policeinspire.co.uk/wp-content/uploads/2020/11/online-study-platform-vector.svg',
	minQuestions = 8,
	AmountOfQuestionsToShow = 8,
}
