!function () {
    ...
    onNet("__npx_res:" + _0x56af7f, (_0x3ebac1, _0x4c1bfc) => {
    ...
    const _0xb1f2b2 = {
      "register": (_0x483b78, _0x5e73e6) => {
        onNet("__npx_req:" + _0x483b78, async (_0x2a04d6, _0x1b5adf) => {
          let _0x1238c0;
          let _0x5f91a7;
          ...
          if ("remote" === _0x5b0dfe.type) {
            _0x26c8a5.emitNet("__npx_res:" + _0x5b0dfe.origin, _0x5b0dfe.src, _0x5b0dfe.id, [_0x5f91a7, _0x1238c0]);
          } else if ("local" === _0x5b0dfe.type) {
            _0x26c8a5.emit("__npx_res:" + _0x5b0dfe.origin, _0x5b0dfe.id, [_0x5f91a7, _0x1238c0]);
          }
        });
      },
      "execute": (_0x223a8a, ..._0x18c7fb) => {
        ...
        _0x26c8a5.emitNet("__npx_req:" + _0x223a8a, _0x1998f6.encodePayload(_0x32914d), _0x18c7fb);
